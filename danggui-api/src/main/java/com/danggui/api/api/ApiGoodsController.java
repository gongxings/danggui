...
import com.danggui.api.entity.AttributeVo;
...
import com.danggui.api.entity.GoodsGalleryVo;
import com.danggui.api.entity.GoodsIssueVo;
import com.danggui.api.entity.GoodsSpecificationVo;
import com.danggui.api.entity.GoodsVo;
import com.danggui.api.entity.ProductVo;
import com.danggui.api.entity.RelatedGoodsVo;
...
import com.danggui.api.service.ApiAttributeService;
...
import com.danggui.api.service.ApiCollectService;
...
import com.danggui.api.service.ApiFootprintService;
import com.danggui.api.service.ApiGoodsGalleryService;
import com.danggui.api.service.ApiGoodsIssueService;
import com.danggui.api.service.ApiGoodsService;
import com.danggui.api.service.ApiGoodsSpecificationService;
import com.danggui.api.service.ApiProductService;
import com.danggui.api.service.ApiRelatedGoodsService;
...
public class ApiGoodsController extends ApiBaseAction {
    ...
    public Object detail(Integer id, Long referrer) {
        ...
        //
        Map<String, Object> issueParam = new HashMap<String, Object>();
//        issueParam.put("goods_id", id);
        ...
        //当前用户是否收藏
        Map<String, Object> collectParam = new HashMap<String, Object>();
        ...
        try {
            ...
            if ((null == enabledCouponVos || enabledCouponVos.size() == 0)
                ...
                if (null != couponVos && couponVos.size() > 0) {
                    ...
                    Map<String, Object> footprintParam = new HashMap<String, Object>();
    ...
    public Object list(@LoginUser UserVo loginUser, Integer categoryId,
        ...
        //筛选的分类
        List<CategoryVo> filterCategory = new ArrayList<CategoryVo>();
        ...
        ApiPageUtils goodsData = new ApiPageUtils(new PageInfo<GoodsVo>(goodsList));
        //搜索到的商品
    ...
    public Object related(@LoginUser UserVo loginUser, Integer id) {
        ...
        List<Integer> relatedGoodsIds = new ArrayList<Integer>();
        ...
        if (null == relatedGoodsIds || relatedGoods.size() < 1) {
            ...
            Map<String, Object> paramRelated = new HashMap<String, Object>();
